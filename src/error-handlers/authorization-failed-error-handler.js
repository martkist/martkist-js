export default class AuthorizationFailedErrorHandler {
    ...
    logAndReturn() {
        let authErrorResponse = this.createCustomErrorResponse(`Service is up at ${this.url}, but authorization failed.  Please check the username and password credentials you used when instantiating the MartkistRpcClient object.`);

...
export default class RpcMethodNotFoundErrorHandler {
    ...
    logAndReturn() {
        let methodNotFoundErrorResponse = this.createCustomErrorResponse(`There is no method titled "${this.methodName}" in the Martkist RPC.  Please verify that your method name is correct and corresponds to the appropriate RPC version.`);

...
export default class ConnectionRefusedErrorHandler {
    ...
    logAndReturn() {
        let cannotConnectErrorResponse = this.createCustomErrorResponse(`Could not connect to the Martkist RPC service.  Please verify that ${this.url} is operational.`);

...
// b) whether the SDK has functional parity with the martkist core.
...
var MartkistParityRegistry = function () {
    function MartkistParityRegistry(martkistClient) {
        (0, _classCallCheck3.default)(this, MartkistParityRegistry);

        this.client = martkistClient;
        this.methodRegistry = this.createMethodRegistry();

        this.assertNoEmptyMappingsInRegistry();
    }

    (0, _createClass3.default)(MartkistParityRegistry, [{
        key: 'assertNoEmptyMappingsInRegistry',
        value: function assertNoEmptyMappingsInRegistry() {
            this.methodRegistry.forEach(function (entry) {
                if (entry.sdkMethods.length === 0 || entry.sdkMethods.filter(function (sdkMethod) {
                    return sdkMethod;
                }).length === 0) {
        ...
        value: function () {
            var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee() {
                var coreMethodList, registryCoreMethods, missingMethods, percentageCoverage;
                return _regenerator2.default.wrap(function _callee$(_context) {
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                _context.next = 2;
                                return this.client.diagnosticServices.getAllRawRpcMethods();

                            case 2:
                                coreMethodList = _context.sent;
                            ...
                            case 5:
                                registryCoreMethods = new _set2.default(this.methodRegistry.map(function (regEntry) {
                                    return regEntry.coreMethod;
                                }));
                                missingMethods = coreMethodList.filter(function (coreMethod) {
                                    return !registryCoreMethods.has(coreMethod.method);
                                });
                                percentageCoverage = (coreMethodList.length - missingMethods.length) / coreMethodList.length * 100;
            ...
            function getParityCheck() {
                return _ref.apply(this, arguments);
            }

            return getParityCheck;
        }()
    }, {
        key: 'createMethodRecord',
        value: function createMethodRecord(coreMethod) {
            ...
            return {
                ...
                sdkMethods: (0, _from2.default)(arguments).slice(1)
            };
        }
    }, {
        key: 'createMethodRegistry',
        value: function createMethodRegistry() {
            var registry = [];
        ...
        key: 'createUtilityMethodMaps',
        value: function createUtilityMethodMaps(utilityServices) {
            var methodMaps = [];
        ...
        key: 'createTransactionMethodMaps',
        value: function createTransactionMethodMaps(transactionServices) {
            var methodMaps = [];
            ...
            methodMaps.push(this.createMethodRecord('getrawtransaction', transactionServices.getRawTransaction, transactionServices.getRawTransactionVerbose));
        ...
        key: 'createSynchronizationMethodMaps',
        value: function createSynchronizationMethodMaps(synchronizationServices) {
            var methodMaps = [];
            methodMaps.push(this.createMethodRecord('mnsync', synchronizationServices.status, synchronizationServices.resetSync, synchronizationServices.updateToNextStep));
            return methodMaps;
        }
    }, {
        key: 'createNetworkMethodMaps',
        value: function createNetworkMethodMaps(networkServices) {
            var methodMaps = [];
            ...
            methodMaps.push(this.createMethodRecord('setnetworkactive', networkServices.activateNetwork, networkServices.deactivateNetwork));
            methodMaps.push(this.createMethodRecord('addnode', networkServices.addNode));
            methodMaps.push(this.createMethodRecord('setban', networkServices.banNodeForLengthOfTime, networkServices.banNodeUntilDate, networkServices.unbanNode));
            ...
            methodMaps.push(this.createMethodRecord('addnode', networkServices.tryToConnectToNode, networkServices.removeNode));
        ...
        key: 'createMixingMethodMaps',
        value: function createMixingMethodMaps(mixingServices) {
            var methodMaps = [];
            methodMaps.push(this.createMethodRecord('privatesend', mixingServices.resetMixing, mixingServices.stopMixing, mixingServices.startMixing));
            return methodMaps;
        }
    }, {
        key: 'createMiningMethodMaps',
        value: function createMiningMethodMaps(miningServices) {
            var methodMaps = [];
        ...
        key: 'createMasternodeMethodMaps',
        value: function createMasternodeMethodMaps(masternodeServices) {
            var methodMaps = [];
            ...
            methodMaps.push(this.createMethodRecord('masternode', masternodeServices.count, masternodeServices.generatePrivateKey, masternodeServices.getConfiguration, masternodeServices.getCurrentMasternodeWinner, masternodeServices.initialize, masternodeServices.outputs, masternodeServices.start, masternodeServices.status, masternodeServices.winner, masternodeServices.winners));
            return methodMaps;
        }
    }, {
        key: 'createMessagingMethodMaps',
        value: function createMessagingMethodMaps(messagingServices) {
            var methodMaps = [];
        ...
        key: 'createGovernanceMethodMaps',
        value: function createGovernanceMethodMaps(governanceServices) {
            var methodMaps = [];
        ...
        key: 'createGenerationMethodMaps',
        value: function createGenerationMethodMaps(generationServices) {
            var methodMaps = [];
        ...
        key: 'createEstimateMethodMaps',
        value: function createEstimateMethodMaps(estimateServices) {
            var methodMaps = [];
        ...
        key: 'createAddressIndexMethodMaps',
        value: function createAddressIndexMethodMaps(addressIndexServices) {
            var methodMaps = [];
            methodMaps.push(this.createMethodRecord('getaddressbalance', addressIndexServices.getAddressBalancesAsArray, addressIndexServices.getSummedAddressBalance));
        ...
        key: 'createBlockchainMethodMaps',
        value: function createBlockchainMethodMaps(blockchainServices) {
            var methodMaps = [];
            methodMaps.push(this.createMethodRecord('getsuperblockbudget', blockchainServices.getSuperBlockBudget));
            methodMaps.push(this.createMethodRecord('getblock', blockchainServices.getBlock, blockchainServices.getBlockVerbose));
            ...
            methodMaps.push(this.createMethodRecord('getblockheader', blockchainServices.getBlockHeader, blockchainServices.getBlockHeaderVerbose));
            methodMaps.push(this.createMethodRecord('getblockheaders', blockchainServices.getBlockHeaders, blockchainServices.getBlockHeadersVerbose));
            ...
            methodMaps.push(this.createMethodRecord('getmempoolancestors', blockchainServices.getMemPoolAncestors, blockchainServices.getMemPoolAncestorsVerbose));
            methodMaps.push(this.createMethodRecord('getmempooldescendants', blockchainServices.getMemPoolDescendants, blockchainServices.getMemPoolDescendantsVerbose));
            ...
            methodMaps.push(this.createMethodRecord('getrawmempool', blockchainServices.getRawMemPool, blockchainServices.getRawMemPoolVerbose));
            ...
            methodMaps.push(this.createMethodRecord('verifytxoutproof', blockchainServices.verifyTxOut, blockchainServices.verifyTxOutProof));
            return methodMaps;
        }
    }, {
        key: 'createWalletMethodMaps',
        value: function createWalletMethodMaps(walletServices) {
            var methodMaps = [];
            ...
            methodMaps.push(this.createMethodRecord('aliasupdate', walletServices.alias.update, walletServices.alias.updateEstimatedFee));
            ...
            methodMaps.push(this.createMethodRecord('prunemartkistservices', walletServices.pruneMartkistServices));
            ...
            methodMaps.push(this.createMethodRecord('martkistdecoderawtransaction', walletServices.martkistDecodeRawTransaction));
            methodMaps.push(this.createMethodRecord('martkistlistreceivedbyaddress', walletServices.martkistListReceivedByAddress));
            methodMaps.push(this.createMethodRecord('martkistsendrawtransaction', walletServices.martkistSendRawTransaction));
            methodMaps.push(this.createMethodRecord('martkisttxfund', walletServices.martkistTxFund));
    ...
    return MartkistParityRegistry;
}();

exports.default = MartkistParityRegistry;
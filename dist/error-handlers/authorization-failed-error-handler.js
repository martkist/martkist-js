...
var AuthorizationFailedErrorHandler = function () {
    ...
    (0, _createClass3.default)(AuthorizationFailedErrorHandler, [{
        ...
        value: function logAndReturn() {
            var authErrorResponse = this.createCustomErrorResponse("Service is up at " + this.url + ", but authorization failed.  Please check the username and password credentials you used when instantiating the MartkistRpcClient object.");

...
var RpcMethodNotFoundErrorHandler = function () {
    ...
    (0, _createClass3.default)(RpcMethodNotFoundErrorHandler, [{
        ...
        value: function logAndReturn() {
            var methodNotFoundErrorResponse = this.createCustomErrorResponse('There is no method titled "' + this.methodName + '" in the Martkist RPC.  Please verify that your method name is correct and corresponds to the appropriate RPC version.');

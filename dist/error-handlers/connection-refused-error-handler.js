...
var ConnectionRefusedErrorHandler = function () {
    ...
    (0, _createClass3.default)(ConnectionRefusedErrorHandler, [{
        ...
        value: function logAndReturn() {
            var cannotConnectErrorResponse = this.createCustomErrorResponse('Could not connect to the Martkist RPC service.  Please verify that ' + this.url + ' is operational.');

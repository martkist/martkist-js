...
var NonSpecificNetworkErrorHandler = function () {
    ...
    (0, _createClass3.default)(NonSpecificNetworkErrorHandler, [{
        ...
        value: function logAndReturn() {
            var networkErrorResponse = this.createCustomErrorResponse("Encountered an unknown network error.  Please verify that " + this.url + " is active and that the Martkist core instance running is version 3.2 or above.");

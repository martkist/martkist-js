...
var _martkistRpcAddressIndexServices = require('./services/martkist-rpc-address-index-services');

var _martkistRpcBlockchainServices = require('./services/martkist-rpc-blockchain-services');

var _martkistRpcDiagnosticServices = require('./services/martkist-rpc-diagnostic-services');

var _martkistRpcEstimateServices = require('./services/martkist-rpc-estimate-services');

var _martkistRpcGenerationServices = require('./services/martkist-rpc-generation-services');

var _martkistRpcGovernanceServices = require('./services/martkist-rpc-governance-services');

var _martkistRpcMasternodeServices = require('./services/martkist-rpc-masternode-services');

var _martkistRpcMessagingServices = require('./services/martkist-rpc-messaging-services');

var _martkistRpcMiningServices = require('./services/martkist-rpc-mining-services');

var _martkistRpcNetworkServices = require('./services/martkist-rpc-network-services');

var _martkistRpcSynchronizationServices = require('./services/martkist-rpc-synchronization-services');

var _martkistRpcTransactionServices = require('./services/martkist-rpc-transaction-services');

var _martkistRpcUtilityServices = require('./services/martkist-rpc-utility-services');

var _martkistRpcWalletServices = require('./services/martkist-rpc-wallet-services');

var _martkistRpcMixingServices = require('./services/martkist-rpc-mixing-services');
...
var MartkistRpcClient = function MartkistRpcClient() {
    var _this = this;
    ...
    (0, _classCallCheck3.default)(this, MartkistRpcClient);
    ...
    this.addressIndexServices = (0, _martkistRpcAddressIndexServices.martkistRpcAddressIndexServices)(callRpc);
    this.blockchainServices = (0, _martkistRpcBlockchainServices.martkistRpcBlockchainServices)(callRpc);
    this.diagnosticServices = (0, _martkistRpcDiagnosticServices.martkistRpcDiagnosticServices)(callRpc);
    this.estimateServices = (0, _martkistRpcEstimateServices.martkistRpcEstimateServices)(callRpc);
    this.generationServices = (0, _martkistRpcGenerationServices.martkistRpcGenerationServices)(callRpc);
    this.governanceServices = (0, _martkistRpcGovernanceServices.martkistRpcGovernanceServices)(callRpc);
    this.masternodeServices = (0, _martkistRpcMasternodeServices.martkistRpcMasternodeServices)(callRpc);
    this.messagingServices = (0, _martkistRpcMessagingServices.martkistRpcMessagingServices)(callRpc);
    this.miningServices = (0, _martkistRpcMiningServices.martkistRpcMiningServices)(callRpc);
    this.mixingServices = (0, _martkistRpcMixingServices.martkistRpcMixingServices)(callRpc);
    this.networkServices = (0, _martkistRpcNetworkServices.martkistRpcNetworkServices)(callRpc);
    this.synchronizationServices = (0, _martkistRpcSynchronizationServices.martkistRpcSynchronizationServices)(callRpc);
    this.transactionServices = (0, _martkistRpcTransactionServices.martkistRpcTransactionServices)(callRpc);
    this.utilityServices = (0, _martkistRpcUtilityServices.martkistRpcUtilityServices)(callRpc);
    this.walletServices = (0, _martkistRpcWalletServices.martkistRpcWalletServices)(callRpc, this.utilityServices);
...
exports.default = MartkistRpcClient;
...
exports.martkistRpcBlockchainServices = martkistRpcBlockchainServices;
...
function martkistRpcBlockchainServices(callRpc) {
            ...
            return _regenerator2.default.wrap(function _callee2$(_context2) {
                while (1) {
                    switch (_context2.prev = _context2.next) {
                        case 0:
                            (0, _martkistOw2.default)(blockHash, _martkistOw2.default.string.label("getBlock:blockHash").not.empty);
                            Verbose = false;
                            _context2.next = 4;
            ...
            return _regenerator2.default.wrap(function _callee3$(_context3) {
                while (1) {
                    switch (_context3.prev = _context3.next) {
                        case 0:
                            (0, _martkistOw2.default)(blockHash, _martkistOw2.default.string.label("getBlockVerbose:blockHash").not.empty);
                            Verbose = true;
                            _context3.next = 4;
                            return callRpc('getblock', [blockHash, Verbose]);
            ...
            return _regenerator2.default.wrap(function _callee6$(_context6) {
                while (1) {
                    switch (_context6.prev = _context6.next) {
                        case 0:
                            (0, _martkistOw2.default)(height, _martkistOw2.default.number.label("getBlockHash:height").integer.greaterThan(0));
                            _context6.next = 3;
            ...
            return _regenerator2.default.wrap(function _callee7$(_context7) {
                while (1) {
                    switch (_context7.prev = _context7.next) {
                        case 0:
                            (0, _martkistOw2.default)(height, _martkistOw2.default.number.label("getBlockAtHeight:blockHeight").integer.greaterThan(0));
                            _context7.next = 3;
            ...
            return _regenerator2.default.wrap(function _callee8$(_context8) {
                while (1) {
                    switch (_context8.prev = _context8.next) {
                        case 0:
                            (0, _martkistOw2.default)(height, _martkistOw2.default.number.label("getBlockAtHeightVerbose:blockHeight").integer.greaterThan(0));
                            _context8.next = 3;
                            return getBlockHash({ height: height });
            ...
            return _regenerator2.default.wrap(function _callee9$(_context9) {
                while (1) {
                    switch (_context9.prev = _context9.next) {
                        case 0:
                            (0, _martkistOw2.default)(timestampHigh, _martkistOw2.default.number.label("getBlockHashes:timestamp").integer.greaterThan(0));
                            (0, _martkistOw2.default)(timestampLow, _martkistOw2.default.number.label("getBlockHashes:timestamp").integer.greaterThan(0));
                            _context9.next = 4;
            ...
            return _regenerator2.default.wrap(function _callee10$(_context10) {
                while (1) {
                    switch (_context10.prev = _context10.next) {
                        case 0:
                            (0, _martkistOw2.default)(hash, _martkistOw2.default.string.label("getBlockHeader:hash").not.empty);
                            Verbose = false;
                            _context10.next = 4;
            ...
            return _regenerator2.default.wrap(function _callee11$(_context11) {
                while (1) {
                    switch (_context11.prev = _context11.next) {
                        case 0:
                            (0, _martkistOw2.default)(hash, _martkistOw2.default.string.label("getBlockHeaderVerbose:hash").not.empty);
                            Verbose = true;
                            _context11.next = 4;
                            return callRpc('getblockheader', [hash, Verbose]);
            ...
            return _regenerator2.default.wrap(function _callee12$(_context12) {
                while (1) {
                    switch (_context12.prev = _context12.next) {
                        case 0:
                            (0, _martkistOw2.default)(hash, _martkistOw2.default.string.label("getBlockHeaders:hash").not.empty);
                            (0, _martkistOw2.default)(headerCount, _martkistOw2.default.number.label("getBlockHeader:headerCount").integer.greaterThan(0));
                            Verbose = false;
                            _context12.next = 5;
            ...
            return _regenerator2.default.wrap(function _callee13$(_context13) {
                while (1) {
                    switch (_context13.prev = _context13.next) {
                        case 0:
                            (0, _martkistOw2.default)(hash, _martkistOw2.default.string.label("getBlockHeadersVerbose:hash").not.empty);
                            (0, _martkistOw2.default)(headerCount, _martkistOw2.default.number.label("getBlockHeadersVerbose:headerCount").integer.greaterThan(0));
                            Verbose = true;
                            _context13.next = 5;
                            return callRpc('getblockheaders', [hash, headerCount, Verbose]);
            ...
            return _regenerator2.default.wrap(function _callee14$(_context14) {
                while (1) {
                    switch (_context14.prev = _context14.next) {
                        case 0:
                            if (count) {
                                (0, _martkistOw2.default)(count, _martkistOw2.default.number.label("getChainTips:count").integer.greaterThan(0));
                            }
                            if (branchLength) {
                                (0, _martkistOw2.default)(branchLength, _martkistOw2.default.number.label("getChainTips:branchLength").integer.greaterThan(0));
                            }
                            _context14.next = 4;
            ...
            return _regenerator2.default.wrap(function _callee17$(_context17) {
                while (1) {
                    switch (_context17.prev = _context17.next) {
                        case 0:
                            (0, _martkistOw2.default)(txid, _martkistOw2.default.string.label("getMemPoolAncestors:txid").not.empty);
                            Verbose = false;
                            _context17.next = 4;
            ...
            return _regenerator2.default.wrap(function _callee18$(_context18) {
                while (1) {
                    switch (_context18.prev = _context18.next) {
                        case 0:
                            (0, _martkistOw2.default)(txid, _martkistOw2.default.string.label("getMemPoolAncestorsVerbose:txid").not.empty);
                            Verbose = true;
                            _context18.next = 4;
                            return callRpc('getmempoolancestors', [txid, Verbose]);
            ...
            return _regenerator2.default.wrap(function _callee19$(_context19) {
                while (1) {
                    switch (_context19.prev = _context19.next) {
                        case 0:
                            (0, _martkistOw2.default)(txid, _martkistOw2.default.string.label("getMemPoolDescendants:txid").not.empty);
                            Verbose = false;
                            _context19.next = 4;
            ...
            return _regenerator2.default.wrap(function _callee20$(_context20) {
                while (1) {
                    switch (_context20.prev = _context20.next) {
                        case 0:
                            (0, _martkistOw2.default)(txid, _martkistOw2.default.string.label("getMemPoolDescendantsVerbose:txid").not.empty);
                            Verbose = true;
                            _context20.next = 4;
                            return callRpc('getmempooldescendants', [txid, Verbose]);
            ...
            return _regenerator2.default.wrap(function _callee21$(_context21) {
                while (1) {
                    switch (_context21.prev = _context21.next) {
                        case 0:
                            (0, _martkistOw2.default)(txid, _martkistOw2.default.string.label("getMemPoolEntry:txid").not.empty);
                            _context21.next = 3;
            ...
            return _regenerator2.default.wrap(function _callee25$(_context25) {
                while (1) {
                    switch (_context25.prev = _context25.next) {
                        case 0:
                            (0, _martkistOw2.default)(txid, _martkistOw2.default.string.label("getSpentInfo:txid").not.empty);
                            if (startingBlockHeight) {
                                (0, _martkistOw2.default)(startingBlockHeight, _martkistOw2.default.number.label("getSpentInfo:startingBlockHeight").integer.greaterThan(0));
                            }
                            _context25.next = 4;
            ...
            return _regenerator2.default.wrap(function _callee26$(_context26) {
                while (1) {
                    switch (_context26.prev = _context26.next) {
                        case 0:
                            (0, _martkistOw2.default)(txid, _martkistOw2.default.string.label("getTxOut:txid").not.empty);
                            (0, _martkistOw2.default)(includeMempool, _martkistOw2.default.number.label("getTxOut:includeMempool").integer.greaterThan(0));
                            _context26.next = 4;

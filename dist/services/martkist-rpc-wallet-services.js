...
exports.martkistRpcWalletServices = martkistRpcWalletServices;
...
var _martkistOw = require('martkist-ow');

var _martkistOw2 = _interopRequireDefault(_martkistOw);

var _martkistRpcWalletAliasServices = require('./wallet/martkist-rpc-wallet-alias-services');

var _martkistRpcWalletAssetAllocationServices = require('./wallet/martkist-rpc-wallet-asset-allocation-services');

var _martkistRpcWalletAssetServices = require('./wallet/martkist-rpc-wallet-asset-services');

var _martkistRpcWalletCertificateServices = require('./wallet/martkist-rpc-wallet-certificate-services');

var _martkistRpcWalletEscrowServices = require('./wallet/martkist-rpc-wallet-escrow-services');

var _martkistRpcWalletOfferServices = require('./wallet/martkist-rpc-wallet-offer-services');
...
function martkistRpcWalletServices(callRpc, utilityServices) {
            ...
            return _regenerator2.default.wrap(function _callee$(_context) {
                while (1) {
                    switch (_context.prev = _context.next) {
                        case 0:
                            (0, _martkistOw2.default)(txId, _martkistOw2.default.string.label("abandonTransaction:txId").not.empty);
                            _context.next = 3;
            ...
            return _regenerator2.default.wrap(function _callee2$(_context2) {
                while (1) {
                    switch (_context2.prev = _context2.next) {
                        case 0:
                            (0, _martkistOw2.default)(nRequired, _martkistOw2.default.number.label("addMultiSigAddress:nRequired").integer.greaterThan(0));
                            (0, _martkistOw2.default)(keys, _martkistOw2.default.array.label("addMultiSigAddress:keys").not.empty);
                            if (account) {
                                (0, _martkistOw2.default)(account, _martkistOw2.default.string.label("addMultiSigAddress: account").not.empty);
                            }
            ...
            return _regenerator2.default.wrap(function _callee3$(_context3) {
                while (1) {
                    switch (_context3.prev = _context3.next) {
                        case 0:
                            (0, _martkistOw2.default)(destination, _martkistOw2.default.string.label("backupWallet:destination").not.empty);
                            _context3.next = 3;
            ...
            return _regenerator2.default.wrap(function _callee5$(_context5) {
                while (1) {
                    switch (_context5.prev = _context5.next) {
                        case 0:
                            (0, _martkistOw2.default)(address, _martkistOw2.default.string.label("dumpPrivKey:address").not.empty);
                            _context5.next = 3;
            ...
            return _regenerator2.default.wrap(function _callee6$(_context6) {
                while (1) {
                    switch (_context6.prev = _context6.next) {
                        case 0:
                            (0, _martkistOw2.default)(fileName, _martkistOw2.default.string.label("dumpWallet:fileName").not.empty);
                            _context6.next = 3;
            ...
            return _regenerator2.default.wrap(function _callee7$(_context7) {
                while (1) {
                    switch (_context7.prev = _context7.next) {
                        case 0:
                            (0, _martkistOw2.default)(address, _martkistOw2.default.string.label("getAccount:address").not.empty);
                            _context7.next = 3;
            ...
            return _regenerator2.default.wrap(function _callee8$(_context8) {
                while (1) {
                    switch (_context8.prev = _context8.next) {
                        case 0:
                            (0, _martkistOw2.default)(account, _martkistOw2.default.string.label("getAccountAddress:account").not.empty);
                            _context8.next = 3;
            ...
            return _regenerator2.default.wrap(function _callee9$(_context9) {
                while (1) {
                    switch (_context9.prev = _context9.next) {
                        case 0:
                            (0, _martkistOw2.default)(account, _martkistOw2.default.string.label("getAddressesByAccount:account").not.empty);
                            _context9.next = 3;
            ...
            return _regenerator2.default.wrap(function _callee10$(_context10) {
                while (1) {
                    switch (_context10.prev = _context10.next) {
                        case 0:
                            (0, _martkistOw2.default)(account, _martkistOw2.default.string.label("getBalance:account").not.empty);
                            if (minConf) {
                                (0, _martkistOw2.default)(minConf, _martkistOw2.default.number.label("getBalance:minConf").integer.greaterThanOrEqual(1));
                            }
                            if (addLocked) {
                                (0, _martkistOw2.default)(addLocked, _martkistOw2.default.boolean.label("getBalance:addLocked").is(function (x) {
                                    return x == true || x == false;
                                }));
                            }
                            if (includeWatchOnly) {
                                (0, _martkistOw2.default)(includeWatchOnly, _martkistOw2.default.boolean.label("getBalance:includeWatchOnly").is(function (x) {
                                    return x == true || x == false;
                                }));
                            }
                            _context10.next = 6;
            ...
            return _regenerator2.default.wrap(function _callee11$(_context11) {
                while (1) {
                    switch (_context11.prev = _context11.next) {
                        case 0:
                            if (account) {
                                (0, _martkistOw2.default)(account, _martkistOw2.default.string.label("getNewAddress:account").not.empty);
                            }
                            _context11.next = 3;
            ...
            return _regenerator2.default.wrap(function _callee12$(_context12) {
                while (1) {
                    switch (_context12.prev = _context12.next) {
                        case 0:
                            (0, _martkistOw2.default)(address, _martkistOw2.default.string.label("getRawChangeAddress:address").not.empty);
                            _context12.next = 3;
            ...
            return _regenerator2.default.wrap(function _callee13$(_context13) {
                while (1) {
                    switch (_context13.prev = _context13.next) {
                        case 0:
                            (0, _martkistOw2.default)(account, _martkistOw2.default.string.label("getReceivedByAccount:account").not.empty);
                            if (minConf) {
                                (0, _martkistOw2.default)(minConf, _martkistOw2.default.number.label("getReceivedByAccount:minConf").integer.greaterThanOrEqual(1));
                            }
                            if (addLocked) {
                                (0, _martkistOw2.default)(addLocked, _martkistOw2.default.boolean.label("getReceivedByAccount:addLocked").is(function (x) {
                                    return x == true || x == false;
                                }));
                            }
                            _context13.next = 5;
            ...
            return _regenerator2.default.wrap(function _callee14$(_context14) {
                while (1) {
                    switch (_context14.prev = _context14.next) {
                        case 0:
                            (0, _martkistOw2.default)(account, _martkistOw2.default.string.label("getReceivedByAddress:account").not.empty);
                            if (minConf) {
                                (0, _martkistOw2.default)(minConf, _martkistOw2.default.number.label("getReceivedByAddress:minConf").integer.greaterThanOrEqual(1));
                            }
                            if (addLocked) {
                                (0, _martkistOw2.default)(addLocked, _martkistOw2.default.boolean.label("getReceivedByAddress:addLocked").is(function (x) {
                                    return x == true || x == false;
                                }));
                            }
                            _context14.next = 5;
            ...
            return _regenerator2.default.wrap(function _callee15$(_context15) {
                while (1) {
                    switch (_context15.prev = _context15.next) {
                        case 0:
                            (0, _martkistOw2.default)(txId, _martkistOw2.default.string.label("getTransaction:txId").not.empty);
                            if (includeWatchOnly) {
                                (0, _martkistOw2.default)(script, _martkistOw2.default.boolean.label("getTransaction:includeWatchOnly").is(function (x) {
                                    return x == true || x == false;
                                }));
                            }
                            _context15.next = 4;
            ...
            return _regenerator2.default.wrap(function _callee18$(_context18) {
                while (1) {
                    switch (_context18.prev = _context18.next) {
                        case 0:
                            (0, _martkistOw2.default)(script, _martkistOw2.default.string.label("importAddress:script").not.empty);
                            if (label) {
                                (0, _martkistOw2.default)(label, _martkistOw2.default.array.label("importAddress:label").not.empty);
                            }
                            if (recan) {
                                (0, _martkistOw2.default)(rescan, _martkistOw2.default.boolean.label("importAddress:rescan").is(function (x) {
                                    return x == true || x == false;
                                }));
                            }
                            if (p2sh) {
                                (0, _martkistOw2.default)(p2sh, _martkistOw2.default.boolean.label("importAddress:p2sh").is(function (x) {
                                    return x == true || x == false;
                                }));
                            }
                            _context18.next = 6;
            ...
            return _regenerator2.default.wrap(function _callee19$(_context19) {
                while (1) {
                    switch (_context19.prev = _context19.next) {
                        case 0:
                            (0, _martkistOw2.default)(fileName, _martkistOw2.default.string.label("importMulti:requests").not.empty);
                            if (index) {
                                (0, _martkistOw2.default)(index, _martkistOw2.default.number.label("importMulti:index").integer.greaterThan(0));
                            }
                            _context19.next = 4;
            ...
            return _regenerator2.default.wrap(function _callee20$(_context20) {
                while (1) {
                    switch (_context20.prev = _context20.next) {
                        case 0:
                            (0, _martkistOw2.default)(requests, _martkistOw2.default.array.label("importMulti:requests").not.empty);
                            if (options) {
                                (0, _martkistOw2.default)(options, _martkistOw2.default.array.label("importMulti:options").not.empty);
                            }
                            _context20.next = 4;
    ...
    var importPrivKey = function () {
        var _ref21 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee21(martkistPrivKey, label, rescan) {
            var _args21 = arguments;
            return _regenerator2.default.wrap(function _callee21$(_context21) {
                while (1) {
                    switch (_context21.prev = _context21.next) {
                        case 0:
                            (0, _martkistOw2.default)(martkistPrivKey, _martkistOw2.default.string.label("importPrivKey:martkistPrivKey").not.empty);
                            if (label) {
                                (0, _martkistOw2.default)(label, _martkistOw2.default.string.label("importPrivKey:label").not.empty);
                            }
                            if (rescan) {
                                (0, _martkistOw2.default)(rescan, _martkistOw2.default.boolean.label("importPrivKey:rescan").is(function (x) {
                                    return x == true || x == false;
                                }));
                            }
                            _context21.next = 5;
            ...
            return _regenerator2.default.wrap(function _callee22$(_context22) {
                while (1) {
                    switch (_context22.prev = _context22.next) {
                        case 0:
                            (0, _martkistOw2.default)(rawTransaction, _martkistOw2.default.string.label("importPrunedFunds:rawTransaction").not.empty);
                            (0, _martkistOw2.default)(txOutProof, _martkistOw2.default.string.label("importPrunedFunds:txOutProof").not.empty);
                            _context22.next = 4;
            ...
            return _regenerator2.default.wrap(function _callee23$(_context23) {
                while (1) {
                    switch (_context23.prev = _context23.next) {
                        case 0:
                            (0, _martkistOw2.default)(pubKey, _martkistOw2.default.string.label("importPubKey:pubKey").not.empty);
                            if (label) {
                                (0, _martkistOw2.default)(label, _martkistOw2.default.string.label("importPubKey:label").not.empty);
                            }
                            if (rescan) {
                                (0, _martkistOw2.default)(rescan, _martkistOw2.default.boolean.label("importPubKey:rescan").is(function (x) {
                                    return x == true || x == false;
                                }));
                            }
                            _context23.next = 5;
            ...
            return _regenerator2.default.wrap(function _callee24$(_context24) {
                while (1) {
                    switch (_context24.prev = _context24.next) {
                        case 0:
                            (0, _martkistOw2.default)(fileName, _martkistOw2.default.string.label("importWallet:fileName").not.empty);
                            _context24.next = 3;
            ...
            return _regenerator2.default.wrap(function _callee25$(_context25) {
                while (1) {
                    switch (_context25.prev = _context25.next) {
                        case 0:
                            (0, _martkistOw2.default)(minConf, _martkistOw2.default.string.label("listUnspent:minConf").not.empty);
                            (0, _martkistOw2.default)(amount, _martkistOw2.default.number.label("listUnspent:amount").integer.greaterThan(0));
                            if (comment) {
                                (0, _martkistOw2.default)(comment, _martkistOw2.default.string.label("listUnspent:comment").minLength(0));
                            }
                            if (commentTo) {
                                (0, _martkistOw2.default)(commentTo, _martkistOw2.default.string.label("listUnspent:commentTo").minLength(0));
                            }
                            if (subtractFeeFromAmount) {
                                (0, _martkistOw2.default)(subtractFeeFromAmount, _martkistOw2.default.boolean.label("listUnspent:subtractFeeFromAmount").is(function (x) {
                                    return x == true || x == false;
                                }));
                            }
                            _context25.next = 7;
            ...
            return _regenerator2.default.wrap(function _callee26$(_context26) {
                while (1) {
                    switch (_context26.prev = _context26.next) {
                        case 0:
                            if (genKey) {
                                (0, _martkistOw2.default)(genKey, _martkistOw2.default.number.label("keePassn:genKey").integer.greaterThanOrEqual(1));
                            }
                            _context26.next = 3;
            ...
            return _regenerator2.default.wrap(function _callee27$(_context27) {
                while (1) {
                    switch (_context27.prev = _context27.next) {
                        case 0:
                            if (newSize) {
                                (0, _martkistOw2.default)(newSize, _martkistOw2.default.number.label("keyPoolRefill:newSize").integer.greaterThanOrEqual(1));
                            }
                            _context27.next = 3;
            ...
            return _regenerator2.default.wrap(function _callee28$(_context28) {
                while (1) {
                    switch (_context28.prev = _context28.next) {
                        case 0:
                            if (minConf) {
                                (0, _martkistOw2.default)(minConf, _martkistOw2.default.number.label("listAccounts:minConf").integer.greaterThanOrEqual(1));
                            }
                            if (addLocked) {
                                (0, _martkistOw2.default)(addLocked, _martkistOw2.default.boolean.label("listAccounts:addLocked").is(function (x) {
                                    return x == true || x == false;
                                }));
                            }
                            if (includeWatchOnly) {
                                (0, _martkistOw2.default)(includeWatchOnly, _martkistOw2.default.boolean.label("listAccounts:includeWatchOnly").is(function (x) {
                                    return x == true || x == false;
                                }));
                            }
                            _context28.next = 5;
            ...
            return _regenerator2.default.wrap(function _callee29$(_context29) {
                while (1) {
                    switch (_context29.prev = _context29.next) {
                        case 0:
                            if (minAmount) {
                                (0, _martkistOw2.default)(minAmount, _martkistOw2.default.number.label("listAddressBalances:minAmount").integer.greaterThan(0));
                            }
                            _context29.next = 3;
            ...
            return _regenerator2.default.wrap(function _callee32$(_context32) {
                while (1) {
                    switch (_context32.prev = _context32.next) {
                        case 0:
                            if (minConf) {
                                (0, _martkistOw2.default)(minConf, _martkistOw2.default.number.label("listReceivedByAccount:minConf").integer.greaterThanOrEqual(1));
                            }
                            if (addLocked) {
                                (0, _martkistOw2.default)(addLocked, _martkistOw2.default.boolean.label("listReceivedByAccount:addLocked").is(function (x) {
                                    return x == true || x == false;
                                }));
                            }
                            if (addressess) {
                                (0, _martkistOw2.default)(includeEmpty, _martkistOw2.default.boolean.label("listReceivedByAccount:includeEmpty").is(function (x) {
                                    return x == true || x == false;
                                }));
                            }
                            if (includeUnsafe) {
                                (0, _martkistOw2.default)(includeWatchOnly, _martkistOw2.default.boolean.label("listReceivedByAccount:includeWatchOnly").is(function (x) {
                                    return x == true || x == false;
                                }));
                            }
                            _context32.next = 6;
            ...
            return _regenerator2.default.wrap(function _callee33$(_context33) {
                while (1) {
                    switch (_context33.prev = _context33.next) {
                        case 0:
                            if (minConf) {
                                (0, _martkistOw2.default)(minConf, _martkistOw2.default.number.label("listReceivedByAddress:minConf").integer.greaterThanOrEqual(1));
                            }
                            if (addLocked) {
                                (0, _martkistOw2.default)(addLocked, _martkistOw2.default.boolean.label("listReceivedByAddress:addLocked").is(function (x) {
                                    return x == true || x == false;
                                }));
                            }
                            if (addressess) {
                                (0, _martkistOw2.default)(includeEmpty, _martkistOw2.default.boolean.label("listReceivedByAddress:includeEmpty").is(function (x) {
                                    return x == true || x == false;
                                }));
                            }
                            if (includeUnsafe) {
                                (0, _martkistOw2.default)(includeWatchOnly, _martkistOw2.default.boolean.label("listReceivedByAddress:includeWatchOnly").is(function (x) {
                                    return x == true || x == false;
                                }));
                            }
                            _context33.next = 6;
            ...
            return _regenerator2.default.wrap(function _callee34$(_context34) {
                while (1) {
                    switch (_context34.prev = _context34.next) {
                        case 0:
                            if (blockHash) {
                                (0, _martkistOw2.default)(blockHash, _martkistOw2.default.string.label("listSinceBlock:blockHash").not.empty);
                            }
                            if (targetConfirmations) {
                                (0, _martkistOw2.default)(targetConfirmations, _martkistOw2.default.number.label("listSinceBlock:targetConfirmations").integer.greaterThan(0));
                            }
                            if (includeWatchOnly) {
                                (0, _martkistOw2.default)(includeWatchOnly, _martkistOw2.default.boolean.label("listSinceBlock:includeWatchOnly").is(function (x) {
                                    return x == true || x == false;
                                }));
                            }
                            _context34.next = 5;
            ...
            return _regenerator2.default.wrap(function _callee35$(_context35) {
                while (1) {
                    switch (_context35.prev = _context35.next) {
                        case 0:
                            if (count) {
                                (0, _martkistOw2.default)(count, _martkistOw2.default.number.label("listUnspent:count").integer.greaterThan(0));
                            }
                            if (skip) {
                                (0, _martkistOw2.default)(skip, _martkistOw2.default.number.label("listUnspent:skip").integer.greaterThan(0));
                            }
                            if (includeWatchOnly) {
                                (0, _martkistOw2.default)(includeUnsafe, _martkistOw2.default.boolean.label("listUnspent:includeUnsafe").is(function (x) {
                                    return x == true || x == false;
                                }));
                            }
                            _context35.next = 5;
            ...
            return _regenerator2.default.wrap(function _callee36$(_context36) {
                while (1) {
                    switch (_context36.prev = _context36.next) {
                        case 0:
                            if (minConf) {
                                (0, _martkistOw2.default)(minConf, _martkistOw2.default.number.label("listUnspent:minConf").integer.greaterThanOrEqual(1));
                            }
                            if (maxConf) {
                                (0, _martkistOw2.default)(maxConf, _martkistOw2.default.number.label("listUnspent:maxConf").integer.greaterThanOrEqual(1));
                            }
                            if (addressess) {
                                (0, _martkistOw2.default)(addresses, _martkistOw2.default.object.label("listUnspent:addresses").not.empty);
                            }
                            if (includeUnsafe) {
                                (0, _martkistOw2.default)(includeUnsafe, _martkistOw2.default.boolean.label("listUnspent:includeUnsafe").is(function (x) {
                                    return x == true || x == false;
            ...
            return _regenerator2.default.wrap(function _callee37$(_context37) {
                while (1) {
                    switch (_context37.prev = _context37.next) {
                        case 0:
                            (0, _martkistOw2.default)(unlock, _martkistOw2.default.string.label("lockUnspent:unlock").not.empty);
                            (0, _martkistOw2.default)(transactions, _martkistOw2.default.string.label("lockUnspent:transactions").not.empty);
                            _context37.next = 4;
            ...
            return _regenerator2.default.wrap(function _callee38$(_context38) {
                while (1) {
                    switch (_context38.prev = _context38.next) {
                        case 0:
                            (0, _martkistOw2.default)(fromAccount, _martkistOw2.default.string.label("move:fromAccount").not.empty);
                            (0, _martkistOw2.default)(toAccount, _martkistOw2.default.string.label("move:toAccount").not.empty);
                            (0, _martkistOw2.default)(amount, _martkistOw2.default.number.label("move:amount").integer.greaterThan(0));
                            (0, _martkistOw2.default)(dummy, _martkistOw2.default.string.label("move:dummy").not.empty);
                            (0, _martkistOw2.default)(comment, _martkistOw2.default.string.label("move:comment").string.minLength(0));
                            _context38.next = 7;
    ...
    var pruneMartkistServices = function () {
            ...
            return _regenerator2.default.wrap(function _callee39$(_context39) {
                while (1) {
                    switch (_context39.prev = _context39.next) {
                        case 0:
                            _context39.next = 2;
                            return callRpc('prunemartkistservices');
        ...
        return function pruneMartkistServices() {
            ...
            return _regenerator2.default.wrap(function _callee40$(_context40) {
                while (1) {
                    switch (_context40.prev = _context40.next) {
                        case 0:
                            (0, _martkistOw2.default)(txId, _martkistOw2.default.string.label("removePrunedFunds:txId").not.empty);
                            _context40.next = 3;
            ...
            return _regenerator2.default.wrap(function _callee41$(_context41) {
                while (1) {
                    switch (_context41.prev = _context41.next) {
                        case 0:
                            (0, _martkistOw2.default)(fromAccount, _martkistOw2.default.string.label("sendFrom:fromAccount").not.empty);
                            (0, _martkistOw2.default)(toAddress, _martkistOw2.default.string.label("sendFrom:fromAccount").not.empty);
                            (0, _martkistOw2.default)(amount, _martkistOw2.default.number.label("sendFrom:fromAccount").not.empty);
                            if (minConf) {
                                (0, _martkistOw2.default)(number, _martkistOw2.default.number.label("sendFrom:minConf").integer.greaterThanOrEqual(1));
                            }
                            if (addLocked) {
                                (0, _martkistOw2.default)(addLocked, _martkistOw2.default.boolean.label("sendFrom:addLocked").is(function (x) {
                                    return x == true || x == false;
                                }));
                            }
                            if (comment) {
                                (0, _martkistOw2.default)(comment, _martkistOw2.default.string.label("sendFrom:comment").string.minLength(0));
                            }
                            if (commentTo) {
                                (0, _martkistOw2.default)(comment, _martkistOw2.default.string.label("sendFrom:comment").string.minLength(0));
                            }
            ...
            return _regenerator2.default.wrap(function _callee42$(_context42) {
                while (1) {
                    switch (_context42.prev = _context42.next) {
                        case 0:
                            (0, _martkistOw2.default)(fromAccount, _martkistOw2.default.string.label("sendMany:fromAccount").not.empty);
                            (0, _martkistOw2.default)(amounts, _martkistOw2.default.number.label("sendMany:amounts").integer.greaterThan(0));
                            if (minConf) {
                                (0, _martkistOw2.default)(minConf, _martkistOw2.default.number.label("sendMany:minConf").integer.greaterThanOrEqual(1));
                            }
                            if (addLocked) {
                                (0, _martkistOw2.default)(addLocked, _martkistOw2.default.string.label("sendMany:addLocked").not.empty);
                            }
                            if (comment) {
                                (0, _martkistOw2.default)(comment, _martkistOw2.default.string.label("sendMany:comment").string.minLength(0));
                            }
                            if (subtractFeeFromAmount) {
                                (0, _martkistOw2.default)(subtractFeeFromAmount, _martkistOw2.default.boolean.label("sendToAddress:subtractFeeFromAmount").is(function (x) {
                                    return x == true || x == false;
                                }));
                            }
                            if (useIs) {
                                (0, _martkistOw2.default)(useIs, _martkistOw2.default.string.label("sendToAddress:useIs").not.empty);
                            }
                            if (usePs) {
                                (0, _martkistOw2.default)(usePs, _martkistOw2.default.string.label("sendToAddress:usePs").not.empty);
                            }
            ...
            return _regenerator2.default.wrap(function _callee43$(_context43) {
                while (1) {
                    switch (_context43.prev = _context43.next) {
                        case 0:
                            (0, _martkistOw2.default)(address, _martkistOw2.default.string.label("sendToAddress:address").not.empty);
                            (0, _martkistOw2.default)(amount, _martkistOw2.default.number.label("sendToAddress:amount").integer.greaterThan(0));
                            if (comment) {
                                (0, _martkistOw2.default)(comment, _martkistOw2.default.string.label("sendToAddress:comment").not.empty);
                            }
                            if (commentTo) {
                                (0, _martkistOw2.default)(commentTo, _martkistOw2.default.string.label("sendToAddress:commentTo").not.empty);
                            }
                            if (subtractFeeFromAmount) {
                                (0, _martkistOw2.default)(subtractFeeFromAmount, _martkistOw2.default.boolean.label("sendToAddress:subtractFeeFromAmount").is(function (x) {
                                    return x == true || x == false;
            ...
            return _regenerator2.default.wrap(function _callee44$(_context44) {
                while (1) {
                    switch (_context44.prev = _context44.next) {
                        case 0:
                            (0, _martkistOw2.default)(address, _martkistOw2.default.string.label("setAccount:address").not.empty);
                            (0, _martkistOw2.default)(account, _martkistOw2.default.string.label("setAccount:account").string.minLength(0));
                            _context44.next = 4;
            ...
            return _regenerator2.default.wrap(function _callee45$(_context45) {
                while (1) {
                    switch (_context45.prev = _context45.next) {
                        case 0:
                            (0, _martkistOw2.default)(amount, _martkistOw2.default.string.label("setTxFee(amount) {:amount").not.empty);
                            _context45.next = 3;
            ...
            return _regenerator2.default.wrap(function _callee46$(_context46) {
                while (1) {
                    switch (_context46.prev = _context46.next) {
                        case 0:
                            (0, _martkistOw2.default)(address, _martkistOw2.default.string.label("signMessage:address").not.empty);
                            (0, _martkistOw2.default)(message, _martkistOw2.default.string.label("signMessage:message").not.empty);
                            _context46.next = 4;
    ...
    var martkistDecodeRawTransaction = function () {
            ...
            return _regenerator2.default.wrap(function _callee47$(_context47) {
                while (1) {
                    switch (_context47.prev = _context47.next) {
                        case 0:
                            (0, _martkistOw2.default)(hexString, _martkistOw2.default.string.label("martkistDecodeRawTransaction:hexString").not.empty);
                            _context47.next = 3;
                            return callRpc('martkistdecoderawtransaction', [hexString]);
        ...
        return function martkistDecodeRawTransaction(_x106) {
            return _ref47.apply(this, arguments);
        };
    }();

    var martkistListReceivedByAddress = function () {
            ...
            return _regenerator2.default.wrap(function _callee48$(_context48) {
                while (1) {
                    switch (_context48.prev = _context48.next) {
                        case 0:
                            _context48.next = 2;
                            return callRpc('martkistlistreceivedbyaddress');
        ...
        return function martkistListReceivedByAddress() {
            return _ref48.apply(this, arguments);
        };
    }();

    var martkistSendRawTransaction = function () {
            ...
            return _regenerator2.default.wrap(function _callee49$(_context49) {
                while (1) {
                    switch (_context49.prev = _context49.next) {
                        case 0:
                            (0, _martkistOw2.default)(hexString, _martkistOw2.default.string.label("martkistSendRawTransaction:hexString").not.empty);
                            if (allowHighFees) {
                                (0, _martkistOw2.default)(allowHighFees, _martkistOw2.default.boolean.label("martkistSendRawTransaction:allowHighFees").is(function (x) {
                                    return x == true || x == false;
                                }));
                            }
                            if (instantSend) {
                                (0, _martkistOw2.default)(instantSend, _martkistOw2.default.boolean.label("martkistSendRawTransaction:instantSend").is(function (x) {
                                    return x == true || x == false;
                                }));
                            }
                            _context49.next = 5;
                            return callRpc('martkistsendrawtransaction', _args49);
        ...
        return function martkistSendRawTransaction(_x107, _x108, _x109) {
            return _ref49.apply(this, arguments);
        };
    }();

    var martkistTxFund = function () {
            ...
            return _regenerator2.default.wrap(function _callee50$(_context50) {
                while (1) {
                    switch (_context50.prev = _context50.next) {
                        case 0:
                            (0, _martkistOw2.default)(hexString, _martkistOw2.default.string.label("martkistTxFund:hexString").not.empty);
                            if (addresses) {
                                (0, _martkistOw2.default)(addresses, _martkistOw2.default.object.label("martkistTxFund:address").not.empty);
                            }
                            _context50.next = 4;
                            return callRpc('martkisttxfund', _args50);
        ...
        return function martkistTxFund(_x110, _x111) {
            ...
            return _regenerator2.default.wrap(function _callee51$(_context51) {
                while (1) {
                    switch (_context51.prev = _context51.next) {
                        case 0:
                            (0, _martkistOw2.default)(startTime, _martkistOw2.default.number.label("tpsTestAdd:startTime").integer.greaterThan(0));
                            (0, _martkistOw2.default)(rawTransactions, _martkistOw2.default.array.label("tpsTestEnabled:enabled").not.empty);
                            _context51.next = 4;
            ...
            return _regenerator2.default.wrap(function _callee52$(_context52) {
                while (1) {
                    switch (_context52.prev = _context52.next) {
                        case 0:
                            (0, _martkistOw2.default)(enabled, _martkistOw2.default.boolean.label("tpsTestEnabled:enabled").is(function (x) {
                                return x == true || x == false;
                            }));
                            _context52.next = 3;
            ...
            return _regenerator2.default.wrap(function _callee55$(_context55) {
                while (1) {
                    switch (_context55.prev = _context55.next) {
                        case 0:
                            (0, _martkistOw2.default)(passphrase, _martkistOw2.default.string.label("walletPassPhrase:passphrase").not.empty);
                            (0, _martkistOw2.default)(timeout, _martkistOw2.default.number.label("walletPassPhrase:timeout").integer.greaterThan(0));
                            (0, _martkistOw2.default)(mixingOnly, _martkistOw2.default.boolean.label("walletPassPhrase:mixingOnly").is(function (x) {
                                return x == true || x == false;
                            }));
                            _context55.next = 5;
            ...
            return _regenerator2.default.wrap(function _callee56$(_context56) {
                while (1) {
                    switch (_context56.prev = _context56.next) {
                        case 0:
                            (0, _martkistOw2.default)(passphrase, _martkistOw2.default.string.label("walletPassPhraseChange:oldPassphrase").not.empty);
                            (0, _martkistOw2.default)(newPassphrase, _martkistOw2.default.string.label("walletPassPhraseChange:newPassphrase").not.empty);
                            _context56.next = 4;
            ...
            return _regenerator2.default.wrap(function _callee57$(_context57) {
                while (1) {
                    switch (_context57.prev = _context57.next) {
                        case 0:
                            (0, _martkistOw2.default)(passphrase, _martkistOw2.default.string.label("encryptWallet:passphrase").not.empty);
                            _context57.next = 3;
    ...
    return {
        ...
        alias: (0, _martkistRpcWalletAliasServices.walletAliasServices)(callRpc),
        assetAllocation: (0, _martkistRpcWalletAssetAllocationServices.walletAssetAllocationServices)(callRpc),
        asset: (0, _martkistRpcWalletAssetServices.walletAssetServices)(callRpc),
        backupWallet: backupWallet,
        certificate: (0, _martkistRpcWalletCertificateServices.walletCertificateServices)(callRpc),
        dumpHdInfo: dumpHdInfo,
        dumpPrivKey: dumpPrivKey,
        dumpWallet: dumpWallet,
        escrow: (0, _martkistRpcWalletEscrowServices.walletEscrowServices)(callRpc),
        ...
        move: move,
        offer: (0, _martkistRpcWalletOfferServices.walletOfferServices)(callRpc),
        pruneMartkistServices: pruneMartkistServices,
        ...
        martkistDecodeRawTransaction: martkistDecodeRawTransaction,
        martkistListReceivedByAddress: martkistListReceivedByAddress,
        martkistSendRawTransaction: martkistSendRawTransaction,
        martkistTxFund: martkistTxFund,

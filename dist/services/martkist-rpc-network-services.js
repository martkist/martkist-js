...
exports.martkistRpcNetworkServices = martkistRpcNetworkServices;
...
function martkistRpcNetworkServices(callRpc) {
            ...
            return _regenerator2.default.wrap(function _callee4$(_context4) {
                while (1) {
                    switch (_context4.prev = _context4.next) {
                        case 0:
                            (0, _martkistOw2.default)(version, _martkistOw2.default.string.label("sentinelPing:version").not.empty);
                            _context4.next = 3;
            ...
            return _regenerator2.default.wrap(function _callee5$(_context5) {
                while (1) {
                    switch (_context5.prev = _context5.next) {
                        case 0:
                            (0, _martkistOw2.default)(nodeAddress, _martkistOw2.default.string.label("addNode:nodeAddress").not.empty);
                            _context5.next = 3;
            ...
            return _regenerator2.default.wrap(function _callee8$(_context8) {
                while (1) {
                    switch (_context8.prev = _context8.next) {
                        case 0:
                            (0, _martkistOw2.default)(subnetOrIp, _martkistOw2.default.string.label("banNodeUntilDate:subnetOrIp").not.empty);
                            (0, _martkistOw2.default)(banTimeInSeconds, _martkistOw2.default.number.label("banNodeForLengthOfTime:banTimeInSeconds").integer.greaterThan(0));
                            AbsoluteTime = false;
                            _context8.next = 5;
            ...
            return _regenerator2.default.wrap(function _callee9$(_context9) {
                while (1) {
                    switch (_context9.prev = _context9.next) {
                        case 0:
                            (0, _martkistOw2.default)(subnetOrIp, _martkistOw2.default.string.label("banNodeUntilDate:subnetOrIp").not.empty);
                            (0, _martkistOw2.default)(banDateTimeEpoch, _martkistOw2.default.number.label("banNodeUntilDate:banDateTimeEpoch").integer.greaterThan(0));
                            AbsoluteTime = true;
                            _context9.next = 5;
            ...
            return _regenerator2.default.wrap(function _callee12$(_context12) {
                while (1) {
                    switch (_context12.prev = _context12.next) {
                        case 0:
                            (0, _martkistOw2.default)(nodeAddress, _martkistOw2.default.string.label("disconnectNode:nodeAddress").not.empty);
                            _context12.next = 3;
            ...
            return _regenerator2.default.wrap(function _callee13$(_context13) {
                while (1) {
                    switch (_context13.prev = _context13.next) {
                        case 0:
                            if (nodeAddress) {
                                (0, _martkistOw2.default)(nodeAddress, _martkistOw2.default.string.label("getAddedNodeInfo:nodeAddress").not.empty);
                            }
            ...
            return _regenerator2.default.wrap(function _callee14$(_context14) {
                while (1) {
                    switch (_context14.prev = _context14.next) {
                        case 0:
                            (0, _martkistOw2.default)(ownerAddress, _martkistOw2.default.string.label("aliasClearWhiteList:ownerAddress").not.empty);
                            (0, _martkistOw2.default)(witness, _martkistOw2.default.string.label("aliasClearWhiteList:witness").not.empty);
                            _context14.next = 4;
            ...
            return _regenerator2.default.wrap(function _callee22$(_context22) {
                while (1) {
                    switch (_context22.prev = _context22.next) {
                        case 0:
                            (0, _martkistOw2.default)(nodeAddress, _martkistOw2.default.string.label("removeNode:nodeAddress").not.empty);
                            _context22.next = 3;
            ...
            return _regenerator2.default.wrap(function _callee23$(_context23) {
                while (1) {
                    switch (_context23.prev = _context23.next) {
                        case 0:
                            (0, _martkistOw2.default)(nodeAddress, _martkistOw2.default.string.label("tryToConnectToNode:nodeAddress").not.empty);
                            _context23.next = 3;
            ...
            return _regenerator2.default.wrap(function _callee24$(_context24) {
                while (1) {
                    switch (_context24.prev = _context24.next) {
                        case 0:
                            (0, _martkistOw2.default)(subnetOrIp, _martkistOw2.default.string.label("unbanNode:subnetOrIp").not.empty);
                            _context24.next = 3;
                ...
                while (1) {
                    switch (_context25.prev = _context25.next) {
                        case 0:
                            ...
                            (0, _martkistOw2.default)(nBlocks, _martkistOw2.default.number.label("getChainTxStats:nBlocks").integer.greaterThan(0));
                            _context25.next = 4;
                        ...
                        case 5:
                            ...
                            (0, _martkistOw2.default)(blockHash, _martkistOw2.default.string.label("getChainTxStats:blockHash").not.empty);
                            _context25.next = 9;

...
exports.martkistRpcTransactionServices = martkistRpcTransactionServices;
...
function martkistRpcTransactionServices(callRpc) {
            ...
            return _regenerator2.default.wrap(function _callee$(_context) {
                while (1) {
                    switch (_context.prev = _context.next) {
                        case 0:
                            (0, _martkistOw2.default)(inputs, _martkistOw2.default.array.label("createRawTransaction:inputs").not.empty);
                            (0, _martkistOw2.default)(outputs, _martkistOw2.default.object.label("createRawTransaction:outputs").not.empty);
                            (0, _martkistOw2.default)(lockTime, _martkistOw2.default.number.label("createRawTransaction:lockTime").greaterThanOrEqualTo(0));
                            _context.next = 5;
            ...
            return _regenerator2.default.wrap(function _callee2$(_context2) {
                while (1) {
                    switch (_context2.prev = _context2.next) {
                        case 0:
                            (0, _martkistOw2.default)(hexString, _martkistOw2.default.string.label("decodeRawTransaction:hexString").not.empty);
                            _context2.next = 3;
            ...
            return _regenerator2.default.wrap(function _callee3$(_context3) {
                while (1) {
                    switch (_context3.prev = _context3.next) {
                        case 0:
                            (0, _martkistOw2.default)(hexString, _martkistOw2.default.string.label("decodeScript:hexString").not.empty);
                            _context3.next = 3;
            ...
            return _regenerator2.default.wrap(function _callee4$(_context4) {
                while (1) {
                    switch (_context4.prev = _context4.next) {
                        case 0:
                            (0, _martkistOw2.default)(hexString, _martkistOw2.default.string.label("fundRawTransaction:hexString").not.empty);
                            if (options) {
                                (0, _martkistOw2.default)(options, _martkistOw2.default.object.label("fundRawTransaction:options").not.empty);
                            }
                            _context4.next = 4;
            ...
            return _regenerator2.default.wrap(function _callee5$(_context5) {
                while (1) {
                    switch (_context5.prev = _context5.next) {
                        case 0:
                            (0, _martkistOw2.default)(txId, _martkistOw2.default.string.label("getRawTransaction:txId").not.empty);
                            verbose = false;
                            _context5.next = 4;
            ...
            return _regenerator2.default.wrap(function _callee6$(_context6) {
                while (1) {
                    switch (_context6.prev = _context6.next) {
                        case 0:
                            (0, _martkistOw2.default)(txId, _martkistOw2.default.string.label("getRawTransactionVerbose:txId").not.empty);
                            verbose = true;
                            _context6.next = 4;
                            return callRpc('getrawtransaction', [txId, verbose]);
            ...
            return _regenerator2.default.wrap(function _callee7$(_context7) {
                while (1) {
                    switch (_context7.prev = _context7.next) {
                        case 0:
                            (0, _martkistOw2.default)(hexString, _martkistOw2.default.string.label("sendRawTransaction:hexString").not.empty);
                            (0, _martkistOw2.default)(allowHighFees, _martkistOw2.default.boolean.label("sendRawTransaction:allowHighFees").is(function (x) {
                                return x == true || x == false;
                            }));
                            (0, _martkistOw2.default)(instantSend, _martkistOw2.default.boolean.label("sendRawTransaction:instantSend").is(function (x) {
                                return x == true || x == false;
                            }));
                            (0, _martkistOw2.default)(bypassLimits, _martkistOw2.default.boolean.label("sendRawTransaction:bypassLimits").is(function (x) {
                                return x == true || x == false;
                            }));
                            _context7.next = 6;
            ...
            return _regenerator2.default.wrap(function _callee8$(_context8) {
                while (1) {
                    switch (_context8.prev = _context8.next) {
                        case 0:
                            (0, _martkistOw2.default)(hexString, _martkistOw2.default.string.label("signRawTransaction:hexString").not.empty);
                            ...
                            (0, _martkistOw2.default)(previousTransactionOutputs, _martkistOw2.default.array.label("signRawTransaction:previousTransactionOutputs").not.empty);
                            (0, _martkistOw2.default)(privateKeys, _martkistOw2.default.array.label("signRawTransaction:privateKeys").not.empty);
                            _context8.next = 6;

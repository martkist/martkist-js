...
exports.martkistRpcMiningServices = martkistRpcMiningServices;
...
function martkistRpcMiningServices(callRpc) {
            ...
            return _regenerator2.default.wrap(function _callee$(_context) {
                while (1) {
                    switch (_context.prev = _context.next) {
                        case 0:
                            (0, _martkistOw2.default)(address, _martkistOw2.default.string.label("createAuxBlock:address").not.empty);
                            _context.next = 3;
            ...
            return _regenerator2.default.wrap(function _callee2$(_context2) {
                while (1) {
                    switch (_context2.prev = _context2.next) {
                        case 0:
                            if (blockHash) {
                                (0, _martkistOw2.default)(blockHash, _martkistOw2.default.string.label("getAuxBlock:blockHash").not.empty);
                            }
                            if (blockHash && auxPow) {
                                (0, _martkistOw2.default)(auxPow, _martkistOw2.default.string.label("getAuxBlock:auxPow").not.empty);
                            }
                            _context2.next = 4;
            ...
            return _regenerator2.default.wrap(function _callee3$(_context3) {
                while (1) {
                    switch (_context3.prev = _context3.next) {
                        case 0:
                            if (blockTemplate) {
                                (0, _martkistOw2.default)(blockTemplate, _martkistOw2.default.string.label("getBlockTemplate:blockTemplate").not.empty);
                            }
                            _context3.next = 3;
            ...
            return _regenerator2.default.wrap(function _callee6$(_context6) {
                while (1) {
                    switch (_context6.prev = _context6.next) {
                        case 0:
                            (0, _martkistOw2.default)(numberOfBlocks, _martkistOw2.default.number.label("getNetworkHashesPerSecond:numberOfBlocks").greaterThan(0));
                            (0, _martkistOw2.default)(blockHeight, _martkistOw2.default.number.label("getNetworkHashesPerSecond:blockHeight").greaterThan(0));
                            _context6.next = 4;
            ...
            return _regenerator2.default.wrap(function _callee7$(_context7) {
                while (1) {
                    switch (_context7.prev = _context7.next) {
                        case 0:
                            (0, _martkistOw2.default)(txid, _martkistOw2.default.string.label("prioritiseTransaction:txid").not.empty);
                            (0, _martkistOw2.default)(priorityDelta, _martkistOw2.default.number.label("prioritiseTransaction:priorityDelta").greaterThan(0));
                            (0, _martkistOw2.default)(feeDeltaInSatoshis, _martkistOw2.default.number.label("prioritiseTransaction:feeDelaInSatoshis").greaterThan(0));
                            _context7.next = 5;
            ...
            return _regenerator2.default.wrap(function _callee8$(_context8) {
                while (1) {
                    switch (_context8.prev = _context8.next) {
                        case 0:
                            (0, _martkistOw2.default)(blockHash, _martkistOw2.default.string.label("submitAuxBlock:blockHash").not.empty);
                            (0, _martkistOw2.default)(auxPow, _martkistOw2.default.string.label("submitAuxBlock:auxPow").not.empty);
                            _context8.next = 4;
            ...
            return _regenerator2.default.wrap(function _callee9$(_context9) {
                while (1) {
                    switch (_context9.prev = _context9.next) {
                        case 0:
                            (0, _martkistOw2.default)(hexDataToSubmit, _martkistOw2.default.string.label("submitBlock:hexDataToSubmit").not.empty);

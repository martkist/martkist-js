...
exports.martkistRpcUtilityServices = martkistRpcUtilityServices;
...
function martkistRpcUtilityServices(callRpc) {
            ...
            return _regenerator2.default.wrap(function _callee$(_context) {
                while (1) {
                    switch (_context.prev = _context.next) {
                        case 0:
                            (0, _martkistOw2.default)(numberOfRequiredSignatures, _martkistOw2.default.number.label("createMultiSig:numberOfRequiredSignatures").integer.greaterThan(0));
                            (0, _martkistOw2.default)(keys, _martkistOw2.default.array.label("createMultiSig:keys").not.empty);
                            _context.next = 4;
            ...
            return _regenerator2.default.wrap(function _callee2$(_context2) {
                while (1) {
                    switch (_context2.prev = _context2.next) {
                        case 0:
                            (0, _martkistOw2.default)(address, _martkistOw2.default.string.label("validateAddress:address").minLength(0));
                            _context2.next = 3;
            ...
            return _regenerator2.default.wrap(function _callee3$(_context3) {
                while (1) {
                    switch (_context3.prev = _context3.next) {
                        case 0:
                            (0, _martkistOw2.default)(category, _martkistOw2.default.string.label("debug:category").minLength(0));
                            _context3.next = 3;
            ...
            return _regenerator2.default.wrap(function _callee4$(_context4) {
                while (1) {
                    switch (_context4.prev = _context4.next) {
                        case 0:
                            (0, _martkistOw2.default)(command, _martkistOw2.default.string.label("help:command").not.empty);
                            _context4.next = 3;
            ...
            return _regenerator2.default.wrap(function _callee5$(_context5) {
                while (1) {
                    switch (_context5.prev = _context5.next) {
                        case 0:
                            (0, _martkistOw2.default)(enabled, _martkistOw2.default.boolean.label("tpsTestSetEnabled:enabled").is(function (x) {
                ...
                while (1) {
                    switch (_context6.prev = _context6.next) {
                        case 0:
                            ...
                            (0, _martkistOw2.default)(rawTx, _martkistOw2.default.array.label("tpsTestAdd:rawTx").not.empty);
                            _context6.next = 4;

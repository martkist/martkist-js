...
exports.martkistRpcGovernanceServices = martkistRpcGovernanceServices;
...
function martkistRpcGovernanceServices(callRpc) {
            ...
            return _regenerator2.default.wrap(function _callee$(_context) {
                while (1) {
                    switch (_context.prev = _context.next) {
                        case 0:
                            (0, _martkistOw2.default)(args, _martkistOw2.default.string.label("callGovernanceCommand:args").not.empty);
                            _context.next = 3;
            ...
            return _regenerator2.default.wrap(function _callee2$(_context2) {
                while (1) {
                    switch (_context2.prev = _context2.next) {
                        case 0:
                            (0, _martkistOw2.default)(proposal, _martkistOw2.default.string.label("checkProposal:proposal").not.empty);
                            _context2.next = 3;
            ...
            return _regenerator2.default.wrap(function _callee3$(_context3) {
                while (1) {
                    switch (_context3.prev = _context3.next) {
                        case 0:
                            (0, _martkistOw2.default)(format, _martkistOw2.default.string.label("count:format").not.empty);
                            _context3.next = 3;
            ...
            return _regenerator2.default.wrap(function _callee4$(_context4) {
                while (1) {
                    switch (_context4.prev = _context4.next) {
                        case 0:
                            (0, _martkistOw2.default)(dataHex, _martkistOw2.default.string.label("deserializeGovernanceObject.dataHex").not.empty);
                            _context4.next = 3;
            ...
            return _regenerator2.default.wrap(function _callee6$(_context6) {
                while (1) {
                    switch (_context6.prev = _context6.next) {
                        case 0:
                            (0, _martkistOw2.default)(hash, _martkistOw2.default.string.label("getByHash.hash").not.empty);
                            _context6.next = 3;
            ...
            return _regenerator2.default.wrap(function _callee8$(_context8) {
                while (1) {
                    switch (_context8.prev = _context8.next) {
                        case 0:
                            (0, _martkistOw2.default)(blockIndex, _martkistOw2.default.number.label("getSuperblockBudget:blockIndex").integer.greaterThan(0));
                            _context8.next = 3;
            ...
            return _regenerator2.default.wrap(function _callee10$(_context10) {
                while (1) {
                    switch (_context10.prev = _context10.next) {
                        case 0:
                            (0, _martkistOw2.default)(hash, _martkistOw2.default.string.label("getVotes.hash").not.empty);
                            _context10.next = 3;
            ...
            return _regenerator2.default.wrap(function _callee16$(_context16) {
                while (1) {
                    switch (_context16.prev = _context16.next) {
                        case 0:
                            (0, _martkistOw2.default)(parentHash, _martkistOw2.default.string.label('prepareGovernanceObject.parentHash').not.empty);
                            (0, _martkistOw2.default)(revision, _martkistOw2.default.number.label('prepareGovernanceObject.revision').not.empty);
                            (0, _martkistOw2.default)(time, _martkistOw2.default.number.label('prepareGovernanceObject.time').not.empty);
                            (0, _martkistOw2.default)(dataHex, _martkistOw2.default.string.label("prepareGovernanceObject.dataHex").not.empty);
                            _context16.next = 6;
            ...
            return _regenerator2.default.wrap(function _callee17$(_context17) {
                while (1) {
                    switch (_context17.prev = _context17.next) {
                        case 0:
                            (0, _martkistOw2.default)(parentHash, _martkistOw2.default.string.label('submitGovernanceObject.parentHash').not.empty);
                            (0, _martkistOw2.default)(revision, _martkistOw2.default.number.label('submitGovernanceObject.revision').not.empty);
                            (0, _martkistOw2.default)(time, _martkistOw2.default.number.label('submitGovernanceObject.time').not.empty);
                            (0, _martkistOw2.default)(dataHex, _martkistOw2.default.string.label("submitGovernanceObject.dataHex").not.empty);
                            (0, _martkistOw2.default)(feeTxId, _martkistOw2.default.string.label("submitGovernanceObject.feeTxId").not.empty);
                            _context17.next = 7;
            ...
            return _regenerator2.default.wrap(function _callee21$(_context21) {
                while (1) {
                    switch (_context21.prev = _context21.next) {
                        case 0:
                            (0, _martkistOw2.default)(masterNodeTxHash, _martkistOw2.default.string.label("callGovernanceCommand:format").not.empty);
                            (0, _martkistOw2.default)(masterNodeTxIndex, _martkistOw2.default.number.label("callGovernanceCommand:format").integer.greaterThan(0));
                            (0, _martkistOw2.default)(governanceHash, _martkistOw2.default.string.label("callGovernanceCommand:format").not.empty);
                            (0, _martkistOw2.default)(voteSignal, _martkistOw2.default.string.label("callGovernanceCommand:format").not.empty);
                            (0, _martkistOw2.default)(vote, _martkistOw2.default.string.label("callGovernanceCommand:vote").is(function (x) {
                                return x == "yes" || x == "no" || x == "abstain";
                            }));
                            (0, _martkistOw2.default)(time, _martkistOw2.default.number.label("callGovernanceCommand:time").integer.greaterThan(0));
                            (0, _martkistOw2.default)(voteSignature, _martkistOw2.default.string.label("callGovernanceCommand:voteSignature").not.empty);
                            _context21.next = 9;
